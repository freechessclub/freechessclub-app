...
function setPanelSizes(secondAdjustment: Boolean = false) {
  ...
  if(!isSmallWindow()) {
    ...
    var widthDiff = $('#board').width() - newBoardWidth - 1; // Add 1px to column size, this is to stop chessground rounding down when board size is e.g. 59.999px due to floating point imprecision.
